...
echo_and_run cd "/home/larswall/workspace/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/larswall/workspace/src/rosserial/rosserial_client/setup.py" \
    build --build-base "/home/larswall/workspace/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
