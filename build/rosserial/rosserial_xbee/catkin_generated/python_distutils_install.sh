...
echo_and_run cd "/home/larswall/workspace/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/larswall/workspace/src/rosserial/rosserial_xbee/setup.py" \
    build --build-base "/home/larswall/workspace/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
