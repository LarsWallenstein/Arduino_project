...
echo_and_run cd "/home/larswall/workspace/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/larswall/workspace/src/rosserial/rosserial_vex_cortex/setup.py" \
    build --build-base "/home/larswall/workspace/build/rosserial/rosserial_vex_cortex" \
    install \
    $DESTDIR_ARG \
