...
echo_and_run cd "/home/larswall/workspace/src/rosserial/rosserial_vex_v5"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/larswall/workspace/src/rosserial/rosserial_vex_v5/setup.py" \
    build --build-base "/home/larswall/workspace/build/rosserial/rosserial_vex_v5" \
    install \
    $DESTDIR_ARG \
